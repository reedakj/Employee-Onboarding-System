    ...
    <div style={{ backgroundColor: "#f5ebe0", minHeight: "100vh", fontFamily: "Arial" }}>
      ...
      <div style={{ marginTop: "40px", padding: "0 40px" }}>
        ...
        {tasks.length === 0 ? (
          ...
          tasks.map((task) => (
            <div key={task.id} style={{ backgroundColor: "white", padding: "20px", borderRadius: "12px", marginBottom: "10px", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 4px 10px rgba(0,0,0,0.1)" }}>
              <div>
                <h3 style={{ margin: 0, color: "#7f5539" }}>{task.task_name}</h3>
                <p style={{ margin: 0 }}>Description: {task.description}</p>
