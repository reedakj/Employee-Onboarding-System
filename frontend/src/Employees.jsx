    ...
    <div style={{ backgroundColor: "#f5ebe0", minHeight: "100vh", fontFamily: "Arial" }}>
      ...
      <div style={{ marginTop: "40px", padding: "0 40px" }}>
        ...
        {employees.length === 0 ? (
          ...
          employees.map((emp) => (
            <div key={emp.id} style={{ backgroundColor: "white", padding: "20px", borderRadius: "12px", marginBottom: "10px", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 4px 10px rgba(0,0,0,0.1)" }}>
              <div>
